...
function switchMode(mode){
  analysisMode=mode==='transcript'?'transcript':mode==='live'?'live':'statement';
  const statement=analysisMode==='statement', live=analysisMode==='live', transcript=analysisMode==='transcript';
  show('statementMode',statement);show('liveMode',live);show('transcriptMode',transcript);
  $('statementModeBtn').classList.toggle('selected',statement);$('liveModeBtn').classList.toggle('selected',live);$('transcriptModeBtn').classList.toggle('selected',transcript);
  $('statementModeBtn').setAttribute('aria-selected',String(statement));$('liveModeBtn').setAttribute('aria-selected',String(live));$('transcriptModeBtn').setAttribute('aria-selected',String(transcript));
  if(transcript){
...
document.addEventListener('DOMContentLoaded',()=>{
  loadLiveSessionState();renderLiveSession();renderHistory();
