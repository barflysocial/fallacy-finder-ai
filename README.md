# ClearSay v1.7.4 — Claim. Clarify. Connect.
...
v1.7.4 keeps a blocking legal-notice gate before any app workflow can be initialized and now requires acknowledgment on every fresh app launch.
...
Keep your existing `OPENAI_API_KEY`. No new environment variable is required for v1.7.4.
...
## Landing page refinements in v1.7.4
...
## Landing page cleanup in v1.7.4
...
## Larger landing brand in v1.7.4
...
## Analyze Claim simplification in v1.7.4
