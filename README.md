# ClearSay v1.8.9 — Screenshot Upload Directions
...
Use the fixed **Appearance** selector to choose System, Light, or Dark. System mode follows the device/browser color scheme and updates live when that system preference changes. The preference is stored only in the current browser.
