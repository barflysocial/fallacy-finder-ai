...
const sessionOverviewSchema = {
  ...
  required: ["summary","scope_warning","main_issue","overall_confidence","common_ground","disputed_points","participant_positions","claim_evolution","reasoning_patterns","agreement_overview","repair_overview","current_disagreement","next_best_questions","caution"]
};
...
const TRANSCRIPT_INTELLIGENCE_VERSION = "clearsay-conversation-intelligence-2026-09-13-v1";
...
const conversationIntelligenceSchema = {
  ...
  required: ["what_is_going_wrong","scope_warning","interaction_cycles","speaker_patterns","supported_complaints","claim_evolution","evidence_graph","repair_mismatch","issue_stacking","highest_leverage_changes","what_needs_to_change","final_note"]
};
...
async function runConversationIntelligence(transcript,turns,finalItems,compactRetry=false){
  ...
  try{
    const response=await openai.responses.create({model:MODEL,reasoning:{effort:"low"},instructions:conversationIntelligenceInstructions(),input,store:false,max_output_tokens:9000,prompt_cache_key:"clearsay-conversation-intelligence-v1",text:{verbosity:"low",format:{type:"json_schema",name:"clearsay_conversation_intelligence",strict:true,schema:conversationIntelligenceSchema}}});
