...
if(!server.includes('app: "ClearSay"')||!server.includes('version: "1.7.4"')) throw new Error('Missing ClearSay v1.7.4 export branding');
console.log('Knowledge check passed: ClearSay v1.7.4 premium landing introduction, per-launch acknowledgment, separate terms page, stronger button/dashboard contrast, 100 fallacies, 12 claim identifiers, repair/agreement reasoning, transcript mode, Self-Guided, response targets, and Couples Live with 15/30/45/60-minute sessions, 1:00 turn control, no inactive drafting, and repeated topic-focus guidance.');
