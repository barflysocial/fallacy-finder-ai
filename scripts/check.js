...
if(!server.includes('app: "ClearSay"')||!server.includes('version: "1.8.2"')) throw new Error('Missing ClearSay v1.8.1 export branding');
...
console.log('Knowledge check passed: ClearSay v1.8.2 premium landing introduction, emergency 911 acknowledgment language, per-launch acknowledgment, separate terms page, stronger button/dashboard contrast, 100 fallacies, 12 claim identifiers, repair/agreement reasoning, transcript mode, Self-Guided, response targets, and Couples Live with 15/30/45/60-minute sessions, 1:00 turn control, no inactive drafting, and repeated topic-focus guidance.');
