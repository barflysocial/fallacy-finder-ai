...
if(!server.includes('COUPLES_MAX_ACTIVE_MS = 15 * 60 * 1000')||!server.includes('couples_live_max_minutes: 15')) throw new Error('Missing Couples Live 15-minute maximum');
...
if(!html.includes('couplesClaimLedger')||!html.includes('couplesAgreementText')||!html.includes('couplesEvidenceText')||!html.includes('couplesOutcome')) throw new Error('Missing v1.5.0 Couples Live panels');
console.log('Knowledge check passed: 100 fallacies, 12 claim identifiers, repair/agreement reasoning, transcript mode, Quick Live, response targets, and Couples Live v1.5.0 guided-session features.');
